...
// Common props
interface IconProps { className?: string, dir?: 'left' | 'down' | 'up' | 'right', style?: React.CSSProperties }
...
export const DiscIcon = ({ className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="2"/></svg>
);
...
export const SearchIcon = ({ className, style }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
);
...
export const ArrowUpDownIcon = ({ className, style }: IconProps) => (
...
export const MicSuitIcon = ({ className, style }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className} style={style}><path d="M12 2C10.3431 2 9 3.34315 9 5V11C9 12.6569 10.3431 14 12 14C13.6569 14 15 12.6569 15 11V5C15 3.34315 13.6569 2 12 2Z" /><path d="M5 10C5 9.44772 5.44772 9 6 9C6.55228 9 7 9.44772 7 10C7 12.7614 9.23858 15 12 15C14.7614 15 17 12.7614 17 10C17 9.44772 17.4477 9 18 9C18.5523 9 19 9.44772 19 10C19 13.5362 16.3768 16.4576 13 16.92V19H15C15.5523 19 16 19.4477 16 20C16 20.5523 15.5523 21 15 21H9C8.44772 21 8 20.5523 8 20C8 19.4477 8.44772 19 9 19H11V16.92C7.62319 16.4576 5 13.5362 5 10Z" /></svg>
);
...
export const SpectrumIcon = ({ className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    <path d="M3 14v-4" />
    <path d="M7 17v-10" />
    <path d="M11 20v-16" />
...
export const BreakdanceIcon = ({ className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const QuestionMarkIcon = ({ className, style }: IconProps) => (
...
export const HexagonIcon = ({ className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 1 0 2 0l7-4A2 2 0 0 0 21 16z" />
  </svg>
);
...
export const AcademicCapIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5"/></svg>
);
...
export const VerifiedIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
    <path d="M12 2l2.426 1.083 2.647-.208 1.463 2.203 2.604.504.31 2.637 2.14 1.554-.86 2.508 1.34 2.28-1.85 1.886.37 2.628-2.53.774-1.1 2.406-2.58-.616L12 22l-2.426-1.083-2.647.208-1.463-2.203-2.604-.504-.31-2.637-2.14-1.554.86-2.508-1.34-2.28 1.85-1.886-.37-2.628 2.53-.774 1.1-2.406 2.58.616L12 2z" />
