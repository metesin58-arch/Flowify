...
export type VocalStyle = 'autotune' | 'raw' | 'aggressive' | 'melodic';
export type Backstory = 'street' | 'rich' | 'underground' | 'social';
export type Personality = 'arrogant' | 'humble' | 'mysterious' | 'energetic';
...
export interface PlayerStats {
  ...
  career: {
    ...
    managerName?: string;
    partnerName?: string;
    chatHistory?: Record<string, { role: 'user' | 'model', text: string }[]>;
  };
