...
const GameContent: React.FC = () => {
      ...
      window.odulVer = (productId?: string) => {
          ...
          setPlayer(prev => {
              ...
              switch (targetId) {
                  ...
                  case 'vip_sub': newStats.isVip = true; newStats.energy = prev.maxEnergy; rewardMsg = "FLOWIFY PRO Aktif Edildi!"; break;
                  case 'verified_tick': 
  ...
  useEffect(() => {
    ...
    return () => { unsubAuth(); if (unsubscribeStats) unsubscribeStats(); };
  }, []);
  ...
  return (
    ...
    <SafeAreaWrapper className="bg-[#121212] text-white">
      ...
      <div className="absolute top-0 left-0 right-0 z-50 p-4 pt-4 flex justify-between items-center bg-gradient-to-b from-black/95 via-black/80 to-transparent pb-8 pointer-events-none">
